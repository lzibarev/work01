/**
 * @class dtb.widgets.designer.SingleSlider
 ...
 */
Ext.define('dtb.widgets.designer.SingleSlider', {
	extend: 'xcp.designer.Component',
	constructor: function(cmp){
		dtb.widgets.designer.SingleSlider.superclass.constructor.call(this, cmp);
...
xcp.designer.ComponentMgr.registerType("dtb_single_slider",dtb.widgets.designer.SingleSlider);
